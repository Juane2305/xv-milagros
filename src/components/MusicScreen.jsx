        ...
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center">
          <div className="bg-white w-80 p-6 rounded-md text-center">
            ...
            <div className="flex flex-col gap-4">
              <button
                className="bg-[#7FB3D5] text-white py-2 rounded hover:bg-[#5A9FBD] transition text-sm"
                onClick={() => handleChoice("withMusic")}
              >
                Con música
              </button>
              <button
                className="bg-gray-400 text-white py-2 rounded hover:bg-gray-500 transition text-sm"
